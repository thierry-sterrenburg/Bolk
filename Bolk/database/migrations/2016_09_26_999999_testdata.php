...
class Testdata extends Migration
{
    ...
    public function up()
    {
        ...
        //components: id int(10)|projectid id(11)|windmillid int(255)|regnumber varchar(255)|name varchar(255)|LENGTH DOUBLE(8,2)|WIDTH DOUBLE(8,2)| HEIGHT DOUBLE(8,2)| WEIGht DOUBLE(8,2)|switchable varchar(255)|status enum|remarks longtex
        DB::table('components')->insert(['projectid' => '1', 'windmillid' => '1', 'regnumber' => '1234569', 'name' => 'PPM', 'length' => null, 'width' => null, 'height' => null, 'weight' => null, 'switchable' => 'null', 'remarks' => '' ]);
        DB::table('components')->insert(['projectid' => '1', 'windmillid' => '1', 'regnumber' => '1234570', 'name' => 'Nacelle', 'length' => null, 'width' => null, 'height' => null, 'weight' => null, 'switchable' => 'null', 'remarks' => '' ]);
        DB::table('components')->insert(['projectid' => '1', 'windmillid' => null, 'regnumber' => '1234570', 'name' => 'Nacelle', 'length' => null, 'width' => null, 'height' => null, 'weight' => null, 'switchable' => 'null', 'remarks' => '' ]);
