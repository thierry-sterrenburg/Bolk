...
class Testdata extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('components')->insert(['projectid' => '1', 'windmillid' => '1', 'regnumber' => '1234569', 'name' => 'PPM', 'length' => null, 'width' => null, 'height' => null, 'weight' => null, 'switchable' => 'null', 'currentlocation'=>'nijverdal', 'remarks' => '' ]);
        DB::table('components')->insert(['projectid' => '1', 'windmillid' => '1', 'regnumber' => '1234570', 'name' => 'Nacelle', 'length' => null, 'width' => null, 'height' => null, 'weight' => null, 'switchable' => 'null', 'currentlocation'=>'nijverdal', 'remarks' => '' ]);
        DB::table('components')->insert(['projectid' => '1', 'windmillid' => null, 'regnumber' => '1234570', 'name' => 'Nacelle', 'length' => null, 'width' => null, 'height' => null, 'weight' => null, 'switchable' => 'null', 'currentlocation'=>'nijverdal', 'remarks' => '' ]);

        //transport: id int(10)|transportnumber varchar(255)|company varchar(255)|truck varchar(255)|trailer varchar(255)|configuration varchar(255)|from varchar(255)|to varchar(255)|dateofloading datetime|  dateofarrivalinitial datetime|dateofarrivalfinal datetime|remarks longtex
        DB::table('transports')->insert(['transportnumber' => '510', 'company' => 'Lubbers', 'truck' => 'Lubbers', 'trailer' => 'LB410', 'configuration' => null, 'from' => 'Spelle', 'to' => 'Nijverdal', 'dateofloading' => '2008-01-01 00:00:00', 'dateofarrivalinitial' => '2008-02-01 00:00:00', 'dateofarrivalfinal' => '2008-02-02 00:00:00', 'remarks' => '' ]);
        DB::table('transports')->insert(['transportnumber' => '520', 'company' => 'Lubbers', 'truck' => 'Lubbers', 'trailer' => 'LB410', 'configuration' => null, 'from' => 'Spelle', 'to' => 'Nijverdal', 'dateofloading' => '2008-02-01 00:00:00', 'dateofarrivalinitial' => '2008-03-01 00:00:00', 'dateofarrivalfinal' => '2008-03-04 00:00:00', 'remarks' => '' ]);
        DB::table('transports')->insert(['transportnumber' => '530', 'company' => 'Lubbers', 'truck' => 'Lubbers', 'trailer' => 'LB410', 'configuration' => null, 'from' => 'Spelle', 'to' => 'Nijverdal', 'dateofloading' => '2008-03-01 00:00:00', 'dateofarrivalinitial' => '2008-04-01 00:00:00', 'dateofarrivalfinal' => '2008-04-06 00:00:00', 'remarks' => '' ]);
        DB::table('transports')->insert(['transportnumber' => '540', 'company' => 'Lubbers', 'truck' => 'Lubbers', 'trailer' => 'LB410', 'configuration' => null, 'from' => 'Spelle', 'to' => 'Nijverdal', 'dateofloading' => '2009-01-01 00:00:00', 'dateofarrivalinitial' => '2009-03-01 00:00:00', 'dateofarrivalfinal' => '2009-04-01 00:00:00', 'remarks' => '' ]);
        DB::table('transports')->insert(['transportnumber' => '511', 'company' => 'Lubbers', 'truck' => 'Lubbers', 'trailer' => 'LB410', 'configuration' => null, 'from' => 'Spelle', 'to' => 'Nijverdal', 'dateofloading' => null, 'dateofarrivalinitial' => null, 'dateofarrivalfinal' => null, 'remarks' => '' ]);
