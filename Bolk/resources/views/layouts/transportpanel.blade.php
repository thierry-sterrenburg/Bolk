									...
									<table class="table table-bordered">
										<tbody>
											...
											<tr>
												...
												<td colspan="1"><u>Configuration:</u> {{$transport->configuration}}</td>
											</tr>
											<tr>
												<td colspan="1"><u>Start location:</u> {{$transport->from}}</td>
												<td colspan="1"><u>End location:</u> {{$transport->to}}</td>
												<td colspan="1"><u>Number of Requirements:</u> {{ComponentController::countRequirements($transport->id)}}</td>
											</tr>
											<tr>
												<td colspan="1"><u>Date of loading:</u> {{$transport->loadingdate}}</td>
